...
@WebFilter(
        servletNames = {"adminServlet","endSessionServlet"}
        ,urlPatterns = {"/admin","/admin.jsp","/end"})
public class adminFilter implements Filter {
    ...
    // this is the main filter. when user login it will add "userRes" to session and this will check if user is logged in
